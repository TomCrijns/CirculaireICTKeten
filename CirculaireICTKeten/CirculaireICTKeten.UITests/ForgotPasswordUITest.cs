...
namespace CirculaireICTKeten.UITests
{
    ...
    public class ForgotPasswordUITest
    {
        ...
        public void NoEmailFilledIn()
        {
            ...
            var chromeOptions = new ChromeOptions();
            chromeOptions.AddArguments("headless");
            string url = "https://test-CirculaireICTKetencore.azurewebsites.net/ForgotPassword/ForgotPassword";
            using(var driver = new ChromeDriver(Path.GetDirectoryName(AppDomain.CurrentDomain.BaseDirectory), chromeOptions))
            {
                //Act
                driver.Navigate().GoToUrl(url);
        ...
        public void ShowResetPasswordPage()
        {
            ...
            string url = String.Format("https://test-CirculaireICTKetencore.azurewebsites.net/ForgotPassword/ResetPassword?email={0}&token={1}", email, encryptedToken);
        ...
        public void InvalidToken()
        {
            ...
            string email = "1816802crijns@zuyd.nl";
            string url = String.Format("https://test-CirculaireICTKetencore.azurewebsites.net/ForgotPassword/ResetPassword?email={0}&token={1}", email, token);
