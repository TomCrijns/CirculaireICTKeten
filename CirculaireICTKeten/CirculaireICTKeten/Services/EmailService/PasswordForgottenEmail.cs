...
using CirculaireICTKeten.Interfaces;
...
namespace CirculaireICTKeten.Services.EmailService
{
    public class PasswordForgottenEmail
    {
        ...
        public static void SendPasswordForgottenEmail(ProfileDataModel user, string token, IConfiguration config)
        {
            ...
            mailcontent.Append("<img src='https://www.CirculaireICTKeten.nl/CirculaireICTKeten.nl/images/ruilwinkel/logo_ruilwinkel_vaalsWEB.jpg'style='width:20%; height:10%;'>");
            ...
            mailcontent.Append(String.Format("<p><em>Deze link is 60 minuten geldig. Bij een ongeldige link kunt u onze <a href='https://CirculaireICTKetencore.azurewebsites.net/ForgotPassword/ForgotPassword'>wachtwoord herstelpagina</a> bezoeken om een nieuwe herstellink te ontvangen.</em></p>"));
            mailcontent.Append(String.Format("<p><a style='background-color:#8b0000; display:inline-block; color:white; padding:8px 16px; margin:8px 0px;border:none;cursor:pointer;border-radius:8px;font-size:12px;text-transform:uppercase;font-family:Helvetica;' href='https://CirculaireICTKetencore.azurewebsites.net/ForgotPassword/ResetPassword?email={0}&token={1}'>Reset wachtwoord</a></p>", user.Email, token));
            ...
            emailMessage.FromAddresses.Add(new EmailAddress("Ruilwinkel Vaals", "noreply@CirculaireICTKeten.nl"));
